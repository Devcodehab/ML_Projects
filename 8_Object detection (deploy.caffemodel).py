  ...
  for i in np.arange(0,detShape):
    ...
    if confidence > confThresh:     
      ...
      if CLASSES[idx] == "bottle":
               cv2.putText(frame, bt, (startX,startY),cv2.FONT_HERSHEY_SIMPLEX, 0.5, COLORS[idx],2)
      elif CLASSES[idx] == "person":
           cv2.putText(frame, at,(startX,startY),cv2.FONT_HERSHEY_SIMPLEX, 0.5, COLORS[idx],2)
      else:
